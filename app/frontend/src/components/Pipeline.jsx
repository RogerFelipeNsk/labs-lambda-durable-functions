...
/**
 * Desenha as cinco etapas do workflow e marca onde a execucao esta.
 *
 * A etapa de pagamento ganha tratamento proprio porque e a unica em que a
 * execucao esta suspensa de verdade — nao "processando".
 *
 * Em falha ou cancelamento o status nao diz onde paramos, so que paramos; por
 * isso caimos no `stage`, que o backend grava a cada transicao.
 */
